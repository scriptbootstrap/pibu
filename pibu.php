...
// query table PIBU
$queryPIBU = query("SELECT * FROM tb_pibu");
...
<head>
	...
	<title>Data Pakta Integritas Badan Usaha - SiKuDa BaJa</title>
...
<body>
	<div class="wrapper">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Pakta Integritas Badan Usaha</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Data Pakta Integritas Badan Usaha</a>
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="add-pibu" class="btn bg-skb-3 text-white btn-round"><i class="fa fa-plus"></i> Buat PIBU</a>
										<h4 class="card-title ml-auto"><?php echo "{$resultPIBU["jmlhPIBU"]}"; ?> Data PIBU</h4>
									</div>
								</div>
								<div class="card-body">
															...
															<div class="form-button-action">
																<div class="dropdown show">
																	...
																	<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																		<a class="dropdown-item text-light bg-skb-3" href="edit-pibu?id_pibu=<?= $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>
																		...
																		<a class="dropdown-item text-light bg-skb-6" href="#" data-toggle="modal" data-target="#delete-pibu<?= $row["id"]; ?>"><i class=" fa fa-trash"></i> Hapus</a>
		...
		<!-- Modal Delete Memo -->
		<?php foreach ($queryPIBU as $row) : ?>
			<div class="modal fade" id="delete-pibu<?= $row["id"]; ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLongTitle">Hapus PIBU?</h5>
						...
						<div class="modal-footer">
							...
							<a href="delete-pibu?id_del_pibu=<?= $row["id"]; ?>" type="button" class="btn bg-skb-1 text-white">Hapus</a>
						</div>
					</div>
				</div>
			</div>
